...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $insertdata = $lg->tracherDataInsert($_POST,$_FILES);  
}
 ?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="card-body p-0">
        ...
        <div class="row">
          <div class="col-lg-5 d-none d-lg-block">
            <img style="height: 300px; width: 446px; margin: 80px 30px;" src="../images/bg_1.jpg">
          </div>
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form method="post" action="" class="user" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" name="phone" class="form-control form-control-user" id="exampleInputPassword" placeholder="Mobile No">
                  </div>
                  <div class="col-sm-6">
                ...
                <div class="form-group">
                 ...
                 <button class="btn btn-primary btn-user btn-block">Registation Now</button>
                <hr>
              </form>
              <hr>
