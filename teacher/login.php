          ...
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block">
                <img style="height: 300px; width: 446px; margin: 50px 30px;" src="../images/bg_1.jpg">
              </div>
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <?php
                    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                      ...
                      $login = $lg->teacherLogin($teacherEmail,$teacherPass);
                  ...
                  <form method="post" action="" class="user">
                   ...
                   <button class="btn btn-primary btn-user btn-block">Login Now</button>
                    <hr>
