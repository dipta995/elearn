...
<div>
            ...
            <div class="row">
                      ...
                      <button class="btn btn-success ado">Attast Files</button>
                        <table class="audio">
                          ...
                          <tr>
                            ...
                            <strong style="color: green; font-size: 16px;"><?php echo $a.'. '.$result['file_title']; ?></strong><form method="get" action="<?php echo $result['file_txt'];?>">
                ...
                <div class="col-lg-5 ml-auto align-self-center">
                  ...
                  ?>
                        ...
                        <p><strong class="text-black d-block">Course name:</strong> <?php  echo $course_name = $result['course_name']; ?></p>
  ...
  if (isset($_POST['sendcmd'])){
      $commentmessage = $com->insertComment($_POST,$courseid);
